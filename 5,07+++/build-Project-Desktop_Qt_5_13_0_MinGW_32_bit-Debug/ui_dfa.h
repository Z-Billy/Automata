...
public:
    ...
    void setupUi(QMainWindow *DFA)
    {
        ...
        actionStart_State = new QAction(DFA);
        actionStart_State->setObjectName(QString::fromUtf8("actionStart_State"));
        actionFInal_State = new QAction(DFA);
    ...
    void retranslateUi(QMainWindow *DFA)
    {
        ...
        actionStart_State->setText(QCoreApplication::translate("DFA", "Start State", nullptr));
        actionFInal_State->setText(QCoreApplication::translate("DFA", "FInal State", nullptr));
